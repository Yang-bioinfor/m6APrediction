...
-   [M](#batch-prediction)[ultiple-Samples Pre](#Multiple-Samples%20Prediction)[diction](#batch-prediction)
-   [Single-Sample Prediction](#Single-Sample%20Prediction)
-   [Model Performance](#Model%20Performance)
-   [License](#License)
-   [Citation](#Citation)
...
### Multiple-Samples Prediction {#Multiple-Samples Prediction}
...
![](figure/ROC_curve.png){width="300"} ![](figure/PRC_curve.png){width="300"}
